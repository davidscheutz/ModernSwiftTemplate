...
extension DetailView.State {
    static let loadedPreviewState = DetailView.State(todo: .loaded(data: .preview1), updatedTitle: .empty, updatedDescription: .empty, isUpdating: false, isDeleting: false)
}
#endif
